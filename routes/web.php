...
Route::middleware(['auth'])->group(function () {
    ...
    Route::post('/departments/{department}/update', [DashboardController::class, 'updateDepartment'])->name('departments.update');
    Route::post('/departments/{department}/delete', [DashboardController::class, 'destroyDepartment'])->name('departments.destroy');
    Route::post('/departments/{department}/toggle', [DashboardController::class, 'toggleDepartmentStatus'])->name('departments.toggle');
    ...
    Route::post('/sections/{section}/update', [DashboardController::class, 'updateSection'])->name('sections.update');
    Route::post('/sections/{section}/delete', [DashboardController::class, 'destroySection'])->name('sections.destroy');
    Route::post('/sections/{section}/toggle', [DashboardController::class, 'toggleSectionStatus'])->name('sections.toggle');
    ...
    Route::post('/options/{option}/delete', [OptionController::class, 'destroy'])->name('options.destroy');
    Route::post('/options/{option}/toggle',[OptionController::class, 'toggleStatus'])->name('options.toggle');
